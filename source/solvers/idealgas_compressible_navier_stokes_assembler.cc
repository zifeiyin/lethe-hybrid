...
template <int dim>
void
GLSIdealGasCompressibleNavierStokesAssemblerCore<dim>::assemble_matrix(
...
template <int dim>
void
GLSIdealGasCompressibleNavierStokesAssemblerCore<dim>::assemble_rhs(
  const NavierStokesScratchData<dim>   &scratch_data,
  StabilizedMethodsTensorCopyData<dim> &copy_data)
{
  // Physical properties
...
template class GLSIdealGasCompressibleNavierStokesAssemblerCore<2>;
template class GLSIdealGasCompressibleNavierStokesAssemblerCore<3>;

template <int dim>
void
GLSIdealGasCompressibleNavierStokesAssemblerBDF<dim>::assemble_matrix(
  const NavierStokesScratchData<dim>   &scratch_data,
  StabilizedMethodsTensorCopyData<dim> &copy_data)
{
  // Physical properties
...
template <int dim>
void
GLSIdealGasCompressibleNavierStokesAssemblerBDF<dim>::assemble_rhs(
  const NavierStokesScratchData<dim>   &scratch_data,
  StabilizedMethodsTensorCopyData<dim> &copy_data)
{
  // Physical properties
...
template class GLSIdealGasCompressibleNavierStokesAssemblerBDF<2>;
template class GLSIdealGasCompressibleNavierStokesAssemblerBDF<3>;
