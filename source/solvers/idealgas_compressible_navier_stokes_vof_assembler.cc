...
template <int dim>
void
GLSIdealGasCompressibleNavierStokesVOFAssemblerCore<dim>::assemble_matrix(
...
template <int dim>
void
GLSIdealGasCompressibleNavierStokesVOFAssemblerCore<dim>::assemble_rhs(
  const NavierStokesScratchData<dim>   &scratch_data,
  StabilizedMethodsTensorCopyData<dim> &copy_data)
{
  const std::vector<double> &viscosity_for_stabilization_vector =
...
template class GLSIdealGasCompressibleNavierStokesVOFAssemblerCore<2>;
template class GLSIdealGasCompressibleNavierStokesVOFAssemblerCore<3>;

template <int dim>
void
GLSIdealGasCompressibleNavierStokesVOFAssemblerBDF<dim>::assemble_matrix(
  const NavierStokesScratchData<dim>   &scratch_data,
  StabilizedMethodsTensorCopyData<dim> &copy_data)
{
  // Loop and quadrature information
...
template <int dim>
void
GLSIdealGasCompressibleNavierStokesVOFAssemblerBDF<dim>::assemble_rhs(
  const NavierStokesScratchData<dim>   &scratch_data,
  StabilizedMethodsTensorCopyData<dim> &copy_data)
{
  // Loop and quadrature information
...
template class GLSIdealGasCompressibleNavierStokesVOFAssemblerBDF<2>;
template class GLSIdealGasCompressibleNavierStokesVOFAssemblerBDF<3>;
