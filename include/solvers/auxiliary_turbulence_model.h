...
#ifndef lethe_auxiliary_turbulence_model_h
#define lethe_auxiliary_turbulence_model_h

#include <core/output_struct.h>
#include <core/parameters.h>
#include <core/turbulenceModel_solver.h>
...
class AuxiliaryTurbulenceModel : public TurbulenceModelSolver<VectorType>
{
public:
  /**
   * @brief AuxiliaryTurbulenceModel - Base constructor for Auxiliary turbulence model. At the present
   * moment this is an interface with nothing. The auxiliary physics is a pure
   * virtual class.
   */
  AuxiliaryTurbulenceModel(
    const Parameters::NonLinearSolver non_linear_solver_parameters)
    : TurbulenceModelSolver<VectorType>(non_linear_solver_parameters)
  {}

  /**
   * @brief AuxiliaryTurbulenceModel - Base destructor. At the present
   * moment this is an interface with nothing.
   */
  virtual ~AuxiliaryTurbulenceModel()
  {}
