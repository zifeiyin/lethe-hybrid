...
#ifndef lethe_idealgas_compressible_navier_stokes_vof_assembler_h
#define lethe_idealgas_compressible_navier_stokes_vof_assembler_h
 ...
 */
template <int dim>
class GLSIdealGasCompressibleNavierStokesVOFAssemblerCore
  : public NavierStokesAssemblerBase<dim>
{
public:
  GLSIdealGasCompressibleNavierStokesVOFAssemblerCore(
...
template <int dim>
class GLSIdealGasCompressibleNavierStokesVOFAssemblerBDF
  : public NavierStokesAssemblerBase<dim>
{
public:
  GLSIdealGasCompressibleNavierStokesVOFAssemblerBDF(
    const std::shared_ptr<SimulationControl> &simulation_control)
    : simulation_control(simulation_control)
  {}
